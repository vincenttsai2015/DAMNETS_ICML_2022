...
def train_test_tag_gen(T, el_fstr):
    ...
    for entry in os.scandir(el_fstr):
        ...
        data_process(tg_args, interval, tg_args.biased, time_windows=tg_args.window, data_directory=data_directory, output_directory=output_directory, directed=False)
